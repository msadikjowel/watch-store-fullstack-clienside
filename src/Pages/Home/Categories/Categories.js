        ...
        <div className='categories container text-center mt-5'>
            ...
            <div className="images">
                ...
                <Link to='/allServices' className='navlink'> <div className="img">
                    <img className='img-fluid' src={appleWatch} alt="" />
                    <h3>Apple Watch</h3>
                </div></Link>

                <Link to='/allServices' className='navlink'><div className="img">
                    <img className='img-fluid' src={samsungWatch} alt="" />
                    <h3>Samsung Watch</h3>
                </div></Link>
                <Link to='/allServices' className='navlink'><div className="img">
                    <img className='img-fluid' src={googleWatch} alt="" />
                    <h3>Google Watch</h3>
                </div></Link>
                <Link to='/allServices' className='navlink'> <div className="img">
                    <img className='img-fluid' src={allWatch} alt="" />
